...
int main(int argc, const char * argv[]) {
    ...
    SDL_Window *window = SDL_CreateWindow("Inutilis Inga", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
